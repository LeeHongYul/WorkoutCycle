...
let context = [
    "5분할은 다양한 근육 그룹을 포함하는 균형 잡힌 운동을 할 수 있도록 도와줍니다. 다양한 부위의 근육을 동일하게 발달시키면서도 부상의 위험을 줄일 수 있습니다.",
    "4분할 운동은 각 운동 그룹을 더 큰 규모로 결합하여 운동 시간을 최적으로 활용합니다. 예를 들어, 상체와 하체를 나누어 운동하면 더 많은 근육 그룹을 동시에 활용할 수 있습니다.",
    "2분할 운동은 운동 일정을 단순화하고 시간을 절약할 수 있습니다. 상체와 하체를 나누어 운동하면 하루에 두 번의 운동만으로도 전신을 다룰 수 있습니다. 집중과 강도: 각 운동 그룹에 대해 더 집중하고 높은 강도의 운동을 할 수 있습니다. 운동 시간이 짧고 집중이 필요한 운동을 수행함으로써 근육 성장과 힘 향상에 도움이 됩니다.",
    ...
    "유산소 운동은 지방을 태우고 대사를 촉진시키는 데 효과적입니다. 조깅, 브리스크 걷기, 자전거 타기, 수영 등의 유산소 활동을 선택하세요. 하루에 30분 이상의 유산소 운동을 꾸준히 실시하세요. 고강도의 유산소 운동은 더 많은 칼로리를 소모하고 근육을 강화하는 데 도움이 됩니다. 인터벌 트레이닝, 계단 오르기, HIIT (고강도 간격 운동) 등의 강도 있는 유산소 운동을 추가해보세요."
]
